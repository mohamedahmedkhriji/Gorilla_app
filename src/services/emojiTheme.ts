...
export const emojiHomme = new URL('../../assets/emoji/homme.png', import.meta.url).href;
export const emojiFemme = new URL('../../assets/emoji/femme.png', import.meta.url).href;
