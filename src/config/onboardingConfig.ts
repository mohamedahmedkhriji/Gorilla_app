...
export const DEFAULT_ONBOARDING_CONFIG: OnboardingConfig = {
  ...
  stepMeta: {
    ...
    personal_info: { title: 'Personal Info' },
    fitness_background: { title: 'Background' },
    fitness_goals: { title: 'Fitness Goal' },
    body_type: { title: 'Body Type' },
    goals_availability: { title: 'Availability' },
    workout_split: { title: 'Plan Selection' },
