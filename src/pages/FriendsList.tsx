...
const FRIENDS_LIST_I18N = {
  ...
  fr: {
    ...
    requestPendingTitle: 'Deja en attente',
    ...
    failedToDeclineRequest: 'Impossible d ignorer la demande.',
    requestAcceptedTitle: 'Ami ajoute',
    requestIgnoredTitle: 'Demande ignoree',
    requestAccepted: 'Demande acceptee.',
    requestIgnored: 'Demande ignoree.',
    profileSuffix: 'profil',
    openImagePreview: 'Ouvrir l apercu de la photo de profil',
    member: 'Membre',
    ...
    accept: 'Accepter',
    decline: 'Ignorer',
    tapPhoto: 'Touchez la photo pour l agrandir',
    noPendingFriendRequests: 'Aucune demande d amitie en attente.',
    noUsersForFilter: 'Aucun utilisateur trouve pour ce filtre.',
  },
  de: {
    title: 'Freunde',
    tabFriends: 'Freunde',
