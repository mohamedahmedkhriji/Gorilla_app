...
const BOOKS_LIBRARY_I18N: LocalizedLanguageRecord<BooksLibraryCopy> = {
  en: {
    ...
    t2Author: 'By RepSet',
    t2Description: 'T-2 is a Phase 1 cutting plan with 5 lifting days focused on hamstrings, glutes, upper chest, V-taper back, big legs, 3D back thickness, and recovery.',
