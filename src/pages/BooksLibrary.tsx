...
const BOOKS_LIBRARY_I18N: LocalizedLanguageRecord<BooksLibraryCopy> = {
  en: {
    ...
    t2Author: 'By RepSet',
    t2Description: 'T-2 is a weekly cutting rotation prioritizing hamstrings, glutes, upper chest, lats, side delts, adaptive overload, cardio control, and fatigue-based adjustments.',
  ...
  it: {
    ...
    t2Author: 'Di RepSet',
    t2Description: 'T-2 e una rotazione cutting settimanale con priorita a femorali, glutei, petto alto, dorsali, deltoidi laterali e aggiustamenti basati sulla fatica.',
  ...
  de: {
    ...
    t2Author: 'Von RepSet',
    t2Description: 'T-2 ist eine woechentliche Cutting-Rotation mit Fokus auf Hamstrings, Glutes, obere Brust, Lats, seitliche Schultern und fatiguebasierten Anpassungen.',
  ...
  fr: {
    ...
    t2Author: 'Par RepSet',
    t2Description: 'T-2 est une rotation de seche hebdomadaire avec priorite aux ischios, fessiers, haut de poitrine, dorsaux, deltoides lateraux et ajustements selon la fatigue.',
