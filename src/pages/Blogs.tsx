...
const BLOGS_I18N = {
  ...
  fr: {
    ...
    subtitle: 'Des actualites sur l entrainement, la nutrition, la recuperation et le mental partagees par la communaute.',
    categories: {
      All: 'Tout',
      Women: 'Femmes',
    ...
    noPosts: 'Aucune publication pour le moment. Appuie sur + pour ajouter ta premiere publication.',
    noCategoryPosts: (categoryLabel: string) => `Aucune publication ${categoryLabel.toLowerCase()} dans le fil charge pour l instant.`,
    showAllCategories: 'Afficher toutes les categories',
    loading: 'Chargement...',
    loadMore: 'Voir plus',
    loadingMorePosts: 'Chargement de plus de publications...',
    loadMorePosts: 'Charger plus de publications',
    caughtUp: 'Tu es a jour.',
    ...
    deleteMessage: 'Es-tu sur de vouloir supprimer cette publication ? Cette action est definitive.',
    deleteCancel: 'Annuler',
    deleteConfirmButton: 'Supprimer',
    sharePostAria: 'Partager la publication',
    reactToPost: 'Reagir a la publication',
    reactions: {
      love: 'J adore',
      fire: 'Feu',
      power: 'Puissance',
    ...
    closeShare: 'Fermer la fenetre de partage',
    shareEmpty: 'Choisis ou tu veux partager cette publication.',
    copyLink: 'Copier le lien',
    linkCopied: 'Lien copie.',
    linkCopiedInstagram: 'Lien copie. Colle-le dans un message Instagram.',
    linkCopyFailed: 'Impossible de copier automatiquement le lien.',
    closeFullScreen: 'Fermer les publications en plein ecran',
    newPostTitle: 'Nouvelle publication',
    newPostPlaceholder: 'Partage ton update...',
    womenOnlyLabel: 'Publication reservee aux femmes',
    womenOnlyHint: 'Seules les femmes verront cette publication dans le fil blog.',
    uploadMedia: 'Televerser une image',
    newPostPreviewAlt: 'Apercu de la nouvelle publication',
    publishing: 'Publication en cours...',
    publish: 'Publier',
    commentsTitle: 'Commentaires',
    existingComments: (count: number) => `Commentaires existants : ${count}`,
    loadingComments: 'Chargement des commentaires...',
    noComments: 'Aucun commentaire pour le moment. Ajoute-en un ci-dessous.',
    addCommentPlaceholder: 'Ajouter un commentaire...',
    postComment: 'Publier le commentaire',
    postedRecently: 'Publie recemment',
    postedRecentlyShort: 'recent',
    postedJustNow: 'Publie a l instant',
    postedJustNowShort: 'maintenant',
    postedMinutes: (value: number) => `Publie il y a ${value} min`,
    postedMinutesShort: (value: number) => `il y a ${value} min`,
    postedHours: (value: number) => `Publie il y a ${value} h`,
    postedHoursShort: (value: number) => `il y a ${value} h`,
    postedDays: (value: number) => `Publie il y a ${value} j`,
    postedDaysShort: (value: number) => `il y a ${value} j`,
    shareDefaultDescription: 'Decouvre cette publication sur RepSet.',
    shareCopiedFeedback: 'Lien copie.',
    shareCopiedInstagramFeedback: 'Lien copie. Colle-le dans un message Instagram.',
    shareCopyFailedFeedback: 'Impossible de copier automatiquement le lien.',
    errorDeletePost: 'Impossible de supprimer la publication',
    errorMissingUser: 'Utilisateur connecte introuvable. Merci de te reconnecter.',
    errorLoadFeed: 'Impossible de charger le fil du blog',
    errorLoadMore: 'Impossible de charger plus de publications',
    errorUpdateLike: 'Impossible de mettre a jour la reaction',
    errorLoadComments: 'Impossible de charger les commentaires',
    errorPostComment: 'Impossible de publier le commentaire',
    errorReadFile: 'Impossible de lire le fichier televerse.',
    errorFileTooLarge: 'Le fichier media est trop volumineux.',
    errorDescriptionRequired: 'Ecris une courte description pour la publication.',
    errorDescriptionTooLong: (max: number) => `La description est trop longue (maximum ${max} caracteres).`,
    errorMediaRequired: 'Televerse une image.',
    errorPublish: 'Impossible de publier la publication',
    errorCopyLink: 'La copie dans le presse-papiers a echoue',
    commentRequired: 'Ecris un commentaire avant de l envoyer.',
    mediaAlt: 'Media de la publication',
    mediaAltUserUpload: 'Media televerse par l utilisateur',
    fallbackUser: 'Utilisateur',
    avatarAlt: (name: string) => `Avatar de ${name}`,
    uploadTitle: 'Creation de la publication',
    uploadMessage: 'Merci de patienter un instant...',
